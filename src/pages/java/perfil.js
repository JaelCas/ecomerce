...
document.addEventListener("DOMContentLoaded", async()=>{
    ...
    try {
        const respuesta = await fetch("http://localhost:8081/api/obtener",{
            method:"POST",
    ...
    //crar el menu de usuario 

    contenedor.innerHTML=
    `
    <div class="relative">
    <button id="user-menu-btn"
    class="w-14 h-14 rounded-b-full bg-blue-600 text-white flex items-center justify-center font-bold text-xl shadow-md hover:scale-105 transition-transform">
